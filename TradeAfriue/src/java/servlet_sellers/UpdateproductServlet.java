 ...
 * @author Ferdinand
 */
@WebServlet(name = "UpdateroductServlet", urlPatterns = {"/Updateproduct"})
...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (MyUtils.getLoginedAdmin(session) == null) {
            ...
            /*
            int apid = MyUtils.getLoginedAdmin(session).getId(); 
            System.out.println("id is :" + apid);
            */
            ...
            try {
               ...
               // product.setId(Integer.parseInt(id));
                ...
                product = new Product(pid, name, category, producer, listprice, price, description, shpnWeight, shippnWeightUnit,
                ...
                String errorMssg ;
                if (name == null || shippnWeightUnit == null || status == null || price == 0.00 || shpnWeight == 0.00 || filename == null) {
//|| price == null  || inStockNumber == null || shpnWeight== null
                    ...
                    RequestDispatcher dispatcher //
                            = this.getServletContext().getRequestDispatcher("/WEB-INF/views/admin/UpdateProduct.jsp");//  
                    dispatcher.forward(request, response);
                } else {
                    try {
