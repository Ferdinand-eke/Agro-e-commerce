...
<section>
		...
		<div class="row">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath}/SellerProdAddServlet" method="post"
				>
				<fieldset>
...
<!--					<div class="form-group">
						...
						<div class="col-md-8">
							<label><input value="true" type="radio" name="status"
								checked="checked" /> Active </label> <label><input
								value="false" type="radio" name="status" />
