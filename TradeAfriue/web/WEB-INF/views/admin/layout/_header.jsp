                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="index.jsp"><img src="${pageContext.request.contextPath}/resources/assets/images/home/main.png" alt=""  height="50" width="50"/></a>
                            </div>
...
<!--                                    <li><a href="#"><i class="fa fa-user"></i> Account</a></li>
                                    ...
                                    <div class="btn-group">
                                    <button type="button" class="btn btn-default dropdown-toggle usa" data-toggle="dropdown">
                                        ${loginedAdmin.firstName} ${loginedAdmin.lastName}
                                        <span class="caret"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    <li><a href="${pageContext.request.contextPath}/admindashboard?page=dashboard" class="active">Home</a></li>
                                    <li class="dropdown"><a href="#">Products<i class="fa fa-angle-down"></i></a>
                                        <ul role="menu" class="sub-menu">
                                            <li><a href="${pageContext.request.contextPath}/ListProducts">List Products</a></li>
                                            <li><a href="${pageContext.request.contextPath}/addproduct">Add Product</a></li>
                                            <li><a href="${pageContext.request.contextPath}/CreateAdmin">Create Admin </a></li>
                                        </ul>
                                    </li> 
